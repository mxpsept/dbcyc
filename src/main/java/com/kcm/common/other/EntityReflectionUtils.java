...
public final class EntityReflectionUtils {
	...
	public final static <T> Map<String, Object> fields(T entity) {
		...
		Map<String, Object> results = new HashMap<String, Object>(32);
		if (entity != null) {
				...
				for (Field field : fields) {
					...
					if (!Modifier.isStatic(modifier)) {
						...
						try {
							...
							String prefix = "boolean".equals(clazzType.toString())
									||"class java.lang.Boolean".equals(clazzType.toString())?IS
									:GET;
